...
LOCAL_MODULE := audio.primary.archos
...
LOCAL_SHARED_LIBRARIES := liblog libcutils libtinyalsa libaudioutils libexpat libaudio-resampler libcorkscrew
...
LOCAL_MODULE := audio.hdmi.archos
