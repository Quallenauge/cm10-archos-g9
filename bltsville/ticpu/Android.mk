...
include $(CLEAR_VARS)
BV_CPUVERSION :=$(shell ls device/archos/archos_g9/bltsville/ticpu/lib/android/libbltsville_*.*.so|\
             sed 's/device\/archos\/archos_g9\/bltsville\/ticpu\/lib\/android\/libbltsville_ticpu.//')
...
$(SYMLINKS): $(LOCAL_INSTALLED_MODULE) $(LOCAL_PATH)/Android.mk
	...
	@cp -afr device/archos/archos_g9/bltsville/ticpu/lib/android/libbltsville_ticpu_license.txt $(TARGET_OUT_VENDOR)/lib
